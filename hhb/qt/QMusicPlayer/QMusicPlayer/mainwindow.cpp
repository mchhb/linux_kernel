...
{
    //列表
    connect(songList,SIGNAL(itemDoubleClicked(QListWidgetItem*)),this,SLOT(songListDoubleCliked(QListWidgetItem*)));
...
void MainWindow::pushButtonInit()
{
    ...
    playbackMode->setGeometry((float)700/800*this->geometry().width(), (float)428/480*this->geometry().height(),
                              (float)20/800*this->geometry().width(), (float)20/800*this->geometry().width());//700,428,20,20
    mutePushButton->setGeometry((float)740/800*this->geometry().width(), (float)428/480*this->geometry().height(),
                                (float)20/800*this->geometry().width(), (float)20/800*this->geometry().width());//740,428,20,20
...
void MainWindow::sliderInit()
{
    ...
    songsPlaySlider->setGeometry((float)212/800*this->geometry().width(),
                                 ...
                                 (float)25/480*this->geometry().height());//212,441,350,25设置位置与大小
