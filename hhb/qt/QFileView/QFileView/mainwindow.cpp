...
void MainWindow::mainWindowInit()
{
    ...
    this->setStyleSheet("QMainWindow{background-color: rgba(30, 30, 30, 100%);}");
    ...
    currtenPlaceLineEdit->setGeometry((float)250/800*this->geometry().width(),(float)15/480*this->geometry().height(),
                                      (float)500/800*this->geometry().width(),(float)30/480*this->geometry().height());//195,15,605,30
...
void MainWindow::listWidgetInit()
{
    ...
    fileViewListWidget->setGeometry((float)195/800*this->geometry().width(),(float)50/480*this->geometry().height(),
                                    (float)605/800*this->geometry().width(),(float)430/480*this->geometry().height());//195,50,605,430
...
void MainWindow::pushButttonInit()
{
    ...
    upPushButton->setGeometry((float)200/800*this->geometry().width(),(float)15/480*this->geometry().height(),
	(float)30/800*this->geometry().width(),(float)30/800*this->geometry().width());
}
...
{
    delete ui;
    delete fileViewListWidget;
    delete pathListWidget;
    delete upPushButton;
    delete quickBars;
    delete currtenPlaceLineEdit;
}
