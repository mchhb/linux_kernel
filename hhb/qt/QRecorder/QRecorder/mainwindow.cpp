...
void MainWindow::mainWindowInit()
{
    ...
    graphicsDropShadowEffect->setOffset(20,10);
...
void MainWindow::sliderInit()
{
    ...
    mediaSlider->setGeometry((float)160/600*mainWidget->geometry().width(),(float)220/250*mainWidget->geometry().height(),
                             (float)250/600*mainWidget->geometry().width(),(float)25/250*mainWidget->geometry().height());
    ...
    /* 设置位置与大小 */
    volumeslider->setGeometry((float)500/600*mainWidget->geometry().width(),(float)140/250*mainWidget->geometry().height(),
                              (float)30/600*mainWidget->geometry().width(),(float)75/250*mainWidget->geometry().height());
...
MainWindow::~MainWindow()
{
    ...
    delete labelmediaTitle;

    delete graphicsDropShadowEffect;
    delete mainWidget;

    delete mediaplayer; // 先要删除媒体再删除列表
